...
const ManageClassesMenu = () => {
    ...
    function displayMenu() {
        return <div className={styles.menu}>
            <Link to="/addClasses" className={styles.no_underline}>
                <div className={styles.navigation_box_big}>
                    <div className={styles.navigation_box_big_image_1}></div>
                    Dodaj zajęcia
                </div>
            </Link>
            <Link to="/displayListOfClasses" className={styles.no_underline}>
                <div className={styles.navigation_box_big}>
...
export default ManageClassesMenu