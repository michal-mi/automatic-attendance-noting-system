...
const ManageClassroomsMenu = () => {
    ...
    function displayMenu() {
        return <div className={styles.menu}>
            <Link to="/addClassroom" className={styles.no_underline}>
                <div className={styles.navigation_box_big}>
                    <div className={styles.navigation_box_big_image_1}></div>
                    Dodaj salę
                </div>
            </Link>
            <Link to="/displayListOfClassrooms" className={styles.no_underline}>
                <div className={styles.navigation_box_big}>
...
export default ManageClassroomsMenu