...
//                startActivity(intent);
    ...
    private void makeApiCall(){
        ...
        if(user.getUserRole() == UserRoleEnum.LECTURER.ordinal())
            connectionAsync.execute(jsonString, Config.serverAddress + APIRoutes.PROFILE_LECTURER);
        else
            connectionAsync.execute(jsonString, Config.serverAddress + APIRoutes.PROFILE_STUDENT);
    }
    @Override
