...
public class Attendance extends AppCompatActivity  implements AsyncPostResponse {
    ...
    private void makeApiCall() throws JSONException {
        ...
        connectionAsync.execute(jsonObject.toString(), Config.serverAddress + "groups/getDataAboutGroupSubject/");
    ...
    public void onPostExecute(String jsonString, int responseCode) {
        try {
            ...
            for(int i=0; i<studentsJsonArray.length(); i++){
                ...
                attendanceList.add(new AttendanceModel(surname, firstName,99999, attendance));
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
