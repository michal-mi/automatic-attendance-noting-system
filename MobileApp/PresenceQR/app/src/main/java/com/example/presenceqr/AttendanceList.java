...
//                intent.putExtra("user", user);
    ...
    private void makeApiCall() throws JSONException, ParseException {
        ...
        Log.v("SEND:", jsonObject.toString());
        connectionAsync.execute(jsonObject.toString(), Config.serverAddress + "classes/getAttendanceList/");
    }
    ...
    @Override
    public void onUpdateExecute(String jsonString) {
